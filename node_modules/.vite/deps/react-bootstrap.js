...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-ERFADH4S.js";
import {
  Spinner_default
} from "./chunk-7GMGCP7L.js";
import {
  DEFAULT_BREAKPOINTS,
...
function useWillUnmount(fn) {
  ...
  (0, import_react20.useEffect)(() => () => onUnmount.current(), []);
}
...
function useTimeout() {
  ...
  const handleRef = (0, import_react21.useRef)();
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react23.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react23.useState)(defaultValue);
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react23.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react24.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react25.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react26.useRef)(modifiers);
  const popperInstanceRef = (0, import_react26.useRef)();
  const update = (0, import_react26.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react26.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react26.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react26.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react26.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop2, {
  ...
  const handleMouseCapture = (0, import_react27.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react28.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react28.useRef)(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react29.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react29.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react29.useContext)($b5e257d569688ac6$var$SSRContext);
  ...
  return (0, import_react29.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react29.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react29.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react29.default).createElement((0, import_react29.default).Fragment, null, props.children);
  }
  return (0, import_react29.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react34.useLayoutEffect : import_react34.useEffect;
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false) return ref;
  const warningRef = (0, import_react35.useCallback)((refValue) => {
...
var DropdownMenu2 = React57.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react36.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react36.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React58.forwardRef(({
  ...
  const dropdownContext = (0, import_react37.useContext)(DropdownContext_default);
...
var FormCheck = React69.forwardRef(({
  ...
  const innerFormContext = (0, import_react41.useMemo)(() => ({
...
var Switch = React77.forwardRef((props, ref) => (0, import_jsx_runtime68.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function useMergedRefs2(refA, refB) {
  return (0, import_react48.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
...
function useCallbackRef2() {
  return (0, import_react51.useState)(null);
}
...
function useWillUnmount2(fn) {
  ...
  (0, import_react53.useEffect)(() => () => onUnmount.current(), []);
}
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react54.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react55.useRef)(inProp);
  ...
  const child = (0, import_react55.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react56.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react56.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react56.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react56.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react56.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react56.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react56.useCallback)(normalize(addEndListener), [addEndListener]);
...
var RTGTransition = React87.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime78.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function useTransition({
  ...
  const isInitialRef = (0, import_react57.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react57.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react57.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime79.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime79.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime79.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react58.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime80.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime80.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime80.jsxs)(import_jsx_runtime80.Fragment, {
...
var Modal2 = React97.forwardRef(({
  ...
  const renderBackdrop = (0, import_react60.useCallback)((backdropProps) => (0, import_jsx_runtime88.jsx)("div", {
    ...backdropProps,
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react64.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react65.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React108.forwardRef(({
  ...
  const renderBackdrop = (0, import_react66.useCallback)((backdropProps) => (0, import_jsx_runtime99.jsx)("div", {
    ...backdropProps,
...
var Navbar = React111.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime104.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime104.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime104.jsx)(Component2, {
        ref,
        ...controlledProps,
...
var Popover = React117.forwardRef(({
  ...
  return (0, import_jsx_runtime110.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime109.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime109.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React118.forwardRef(({
  ...
  return (0, import_jsx_runtime112.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime111.jsx)("div", {
      ...
      ...arrowProps
    }), (0, import_jsx_runtime111.jsx)("div", {
...
var Overlay2 = React119.forwardRef(({
  ...
  const [firstRenderedState, setFirstRenderedState] = (0, import_react72.useState)(null);
  ...
  return (0, import_jsx_runtime113.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime116.jsxs)(import_jsx_runtime115.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react73.cloneElement)(children, triggerProps), (0, import_jsx_runtime114.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React121.forwardRef(({
  ...
  return (0, import_jsx_runtime117.jsx)("li", {
    ref,
    style: style2,
    ...
    children: (0, import_jsx_runtime118.jsxs)(Component2, {
      className: (0, import_classnames85.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime117.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React121.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime118.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React122.forwardRef(({
  ...
  return (0, import_jsx_runtime119.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React123.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime120.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime122.jsx)("div", {
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime122.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react75.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react76.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react76.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContent = React132.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React133.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime134.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastFade = React136.forwardRef((props, ref) => (0, import_jsx_runtime136.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React137.createContext({
  onClose() {
  }
});
...
var ToastHeader = React138.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context6 = (0, import_react77.useContext)(ToastContext_default);
  const handleClick = useEventCallback2((e) => {
...
var ToastBody = React139.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React140.forwardRef(({
  ...
  const delayRef = (0, import_react78.useRef)(delay);
  const onCloseRef = (0, import_react78.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react78.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react78.useMemo)(() => ({
    onClose
  }), [onClose]);
...
var ToastContainer = React141.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop7 = () => void 0;
var ToggleButton = React142.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React143.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
